...
ROOT=Path('/config/esp_manager'); PROJECTS=ROOT/'projects'; FIRMWARE=ROOT/'firmware'; OPTIONS_FILE=Path('/data/options.json'); TEMPLATES=Path(__file__).parent/'templates'
