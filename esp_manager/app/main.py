...
CHANNEL='Stable'; ROOT=Path('/config/esp_manager'); PROJECTS=ROOT/'projects'; FIRMWARE=ROOT/'firmware'; BACKUPS=ROOT/'backups'; TEMPLATES=Path(__file__).parent/'templates'
