...
ROOT=Path('/config/esp_manager_dev'); PROJECTS=ROOT/'projects'; FIRMWARE=ROOT/'firmware'; BACKUPS=ROOT/'backups'; OPTIONS=Path('/data/options.json'); TEMPLATES=Path(__file__).parent/'templates'
